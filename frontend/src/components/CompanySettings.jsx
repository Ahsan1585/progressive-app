                ...
                return (
                  <div key={field.key} className={`flex items-center gap-3 rounded-lg border px-3 py-2.5 ${needsInput ? 'border-red-200 bg-red-50/40' : changed ? 'border-amber-200 bg-amber-50/40' : 'border-slate-200 bg-white'}`}>
                    ...
                    <button
                      ...
                      className="flex-shrink-0 w-9 h-9 rounded-md border border-slate-200 text-slate-400 hover:text-red-600 hover:border-red-200 hover:bg-red-50 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:text-slate-400 disabled:hover:border-slate-200 disabled:hover:bg-transparent flex items-center justify-center cursor-pointer transition-colors"
                    >
